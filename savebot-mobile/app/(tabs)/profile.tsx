      ...
      <SafeAreaView style={styles.safeArea}>
        ...
        >
          ...
          <GlassCard style={styles.profileCard}>
            <View style={styles.profileHeader}>
              ...
              <View style={styles.profileInfo}>
                <Text style={styles.name}>Jean Claude Uwimana</Text>
                <Text style={styles.role}>Smallholder Farmer</Text>
                <View style={styles.locationContainer}>
                  <MapPin size={16} color="#06B6D4" />
                  <Text style={styles.location}>Nyagatare District, Rwanda</Text>
                </View>
              </View>
            </View>
          ...
          <View style={styles.versionContainer}>
            <Text style={styles.versionText}>Smartel Save-Bot v1.0.0</Text>
            <Text style={styles.copyrightText}>© 2024 Smartel Technologies</Text>
          </View>
